  ...
  return (
    <footer className='w-full mb-[100px] md:mb-5 pb-10' id="contact">
        ...
        <div className='flex flex-col items-center'>
            ...
            <a href="mailto:mohamedayad4000@gmail.com">
                <MagicButton
        ...
        <div className='flex mt-16 md:flex-row flex-col justify-between '>
            <p className='md:text-base text-sm md:font-normal font-light'>Copyright © 2024 Mohamed Ayad</p>
            <div className='flex items-center md:gap-3 gap-6'>
                {socialMedia.map(({img, id, link, title}) => (
                    <a key={id} href={link} >
                        <div className='w-10 h-10 cursor-pointer flex justify-center items-center backdrop-filter backdrop-blur-lg saturate-180 bg-opacity-75 bg-black-200 rounded-lg border border-black-300'>
                            <img src={img} alt={title} width={20} height={20} />
                        </div>
                    </a>
                ))}
            </div>
