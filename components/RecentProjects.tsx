...
import { FaLocationArrow, FaGithub } from "react-icons/fa" // استوردنا لوجو جيت هاب هنا
        ...
        <div className='flex flex-wrap items-center justify-center p-4 gap-x-24 gap-y-8 mt-10'>
            {projects.map((project) => (
                <div key={project.id} className='sm:h-[41rem] h-[32rem] lg:min-h-[32.5rem] sm:w-[570px] flex items-center justify-center w-[80vw]'>
                    {/* جعلنا الـ Pin الرئيسي يشير للـ Live Link كـ عنوان علوي متحرك */}
                    <PinContainer title={project.liveLink} href={project.liveLink}>
                        ...
                        <div className='flex items-center justify-between mt-7 mb-3'>
                            ...
                            {/* سيكشن اللينكات المزدوجة - مع حماية منع انتشار التقرير onClick */}
                            <div 
                            ...
                            >
                                ...
                                >
                                    <p className='flex lg:text-lg md:text-xs text-sm text-purple'>Live</p>
                                ...
                                <a 
                                  ...
                                  target="_blank" 
                                  rel="noopener noreferrer" 
                                  className='flex items-center hover:opacity-80 transition border-l border-white/[0.2] pl-3'
                                >
                                    <p className='flex lg:text-lg md:text-xs text-sm text-gray-400 hover:text-white transition'>GitHub</p>
