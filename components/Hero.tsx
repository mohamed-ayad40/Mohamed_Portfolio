...
const Hero = () => {
  return (
    <div className='pb-20 pt-36'>
        ...
        <div className="h-screen w-full dark:bg-black-100 bg-white absolute top-0 left-0 dark:bg-grid-white/[0.10] bg-grid-black/[0.2] flex items-center justify-center">
